#/*
 ...
 #* information see here: http://www.gnu.org/copyleft/gpl.html.
 #* Can edit and redistribute code as long as above reference of authorship is
 #* kept within the code.
 #*
 #* Program Description:
 #* This project contains a basic UI shell using python Tk library. A mini UI
 #* with four buttons is displayed. Clicking a botton will execute a function tied
 #* to that button as well as show a message on the screen that the action has
 #* been executed. This basic foundational UI code using Tk can be easily
 #* expanded to
 #* define more complicated functions related to the buttons.
 #*
 #* Dependencies:
